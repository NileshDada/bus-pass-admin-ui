                                        ...
                                        customerMasters.map(
                                            (customerMaster, index) =>   //index is inbuilt variable of map started with 0
                                                <tr key={customerMaster.custId}>
                                                    ...
                                                    <td> <button type="submit" className="btn btn-info" data-toggle="modal" data-target="#updateData" onClick={() => showStudentPassMasterDetailsById(customerMaster.custId)}>Update</button>
                                                        <button type="submit" className="btn col-sm-offset-1 btn-danger" onClick={() => deleteStudentPassById(customerMaster.custId)}>Delete</button>
                                                        <button type="submit" className="btn col-sm-offset-1 btn-success" data-toggle="modal" data-target="#showData" onClick={() => showStudentPassMasterDetailsById(customerMaster.custId)}>View</button></td>
                                                </tr>
                                        )
                                    }
                                </tbody>
            ...
            <div className="modal fade" id="updateData" role="dialog">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="submit" className="btn btn-success" data-dismiss="modal" onClick={(e) => updateStudentPassMaster(e)} > Submit</button>
                            <button type="button" className="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
                    </div>
